    ...
    try:
        with pdfplumber.open(pdf_path) as pdf:
            ...
            def _add_rev(mark, date, remarks):
                import traceback
                print('ADD_REV:', mark, date, remarks)
                traceback.print_stack()
                print(f'ADD_REV: {mark}, {date}, {remarks}')
            ...
            def _try_table_extraction(pdf_page):
                ...
                for table in tables:
                    ...
                    for row_i, row in enumerate(table_list):
                        ...
                        print(f"DEBUG row {row_i}: {row_joined} | has_rev={has_rev}, has_date={has_date}")
                    ...
                    print(f"DEBUG header_idx={header_idx}, col_rev={col_rev}, col_date={col_date}")
